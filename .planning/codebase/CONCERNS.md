...
- Fix approach: The current deployment is single-process, so this is fine. Document the constraint prominently: "Beta gate is single-process. Cannot deploy to serverless without moving counters to Supabase."
