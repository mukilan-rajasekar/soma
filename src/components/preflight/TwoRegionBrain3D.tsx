...
import TwoRegionBrain from "../demo2/TwoRegionBrain";
...
const NODES: readonly Node[] = [
  ...
  { net: 1, mm: [38, 18, 2], reach: 0.21 }, //   anterior insula
  { net: 1, mm: [46, 14, -4], reach: 0.24 }, //  frontal operculum, the insula's lateral face
];

// ── MOTION ────────────────────────────────────────────────────────────────────────────
const SPIN_RATE = 0.19; //   rad/sec about the superior axis (~33 s per full turn)
